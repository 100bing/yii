        ...
        <div class="address">
            ...
            <div class="address_info">
                <p>
                    ...
                    <input type="radio" <?=$address->is_default==1?'checked':''?> value="<?=$address->id?> " name="address_id"/> <?=$address->name?> <?=$address->province?> <?=$address->city?> <?=$address->county?> <?=$address->detail?> <?=$address->tel?></p>
            ...
            <table>
                ...
                <?php foreach($model as $k=>$model):?>
                    <tr>
                        ...
                        <td class="col1">      <?=\yii\helpers\Html::a(\yii\helpers\Html::img($model['logo']))?><strong><?=\yii\helpers\Html::a($model['name'])?></strong></td>
...
<?php
$url=yii\helpers\Url::to(['list/shop']);
