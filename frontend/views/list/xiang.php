        ...
        <div class="preview fl">
            ...
            <div class="smallpic">
                ...
                <div class="smallpic_wrap">
                    <ul>
                        <?php foreach (\backend\models\Goods_img::find()->where(['goods_id'=>$model->id ])->all()as $k=>$mode):?>

                            <li class="<?=$k==0?"cur":""?>">
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m2.jpg',largeimage: 'images/preview_l2.jpg'}"><?php echo \yii\helpers\Html::img(strlen($mode->img)>80?$mode->img:'http://admin.yiishop.com/'.$mode->img)?></a>
                            </li>
...
<!--                        </li>-->
        ...
        <div class="goodsinfo fl ml10">
            ...
            <form action="<?=\yii\helpers\Url::to(['list/add'])?>" method="post" class="choose">
                <ul>
                    ...
                    <li>
                        <dl>
                            <dt>&nbsp;</dt>
                            <dd>  <input type="submit" value="" class="add_btn" />
