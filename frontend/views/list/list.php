    ...
    <ul>
        <?php foreach ($model as $model):?>
            <li>
                ...
                <dt>
                    <?php echo \yii\helpers\Html::a(\yii\helpers\Html::img($model->logo),['list/xiang','id'=>$model->id]) ?>
                </dt>
                    <dd>
                    <?php echo \yii\helpers\Html::a(\backend\models\Goods_intro::findOne(['goods_id'=>$model->id])->content,['list/xiang','id'=>$model->id])?>
                </dd>
                <dd>
                    <strong>
                        <?=$model->shop_price?>
