 ...
 */
class m170612_033619_create_goods_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('goods', [
            'id' => $this->primaryKey(),
            'name'=>$this->string(20)->comment('商品名'),
            ...
            'is_on_sale'=>$this->integer(1)->comment('是否在售（1在售0下架）'),
            'status'=>$this->integer(1)->comment('z状态（1正常0回收站）'),
